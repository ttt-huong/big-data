...
from pipeline import extract_data, transform_data, load_data, PipelineMetrics, logger
...
def run_pipeline(
    ...
    try:
        # 1. EXTRACT
        extracted_df = extract_data(source_input, mode=mode, metrics=metrics, batch_size=batch_size)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--mode", type=str, choices=["full", "incremental"], default="full", help="Chế độ load")
    ...
    run_pipeline(raw_data, mode=args.mode, batch_size=args.batch_size)
